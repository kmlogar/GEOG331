...
filepaths <- c("y:\\Students\\klogar\\a02\\2011124.csv", "/Users/kaylal26/Documents/ColgateAcademics/Spring2020/EnvironmentalDataScience/GitHub/GEOG331/Activity2/2011124.csv")
datW <- read.csv(filepaths[1])
